'use client'
import { ComponentPassingType, ShortUrlResultPrivateType, ShortUrlResultType } from '@/lib/TypeInterface'
...
export default function ShortResultCardDashboard(props: ComponentPassingType) {
  const AppURL: string | undefined = props.AppURL
  const url: ShortUrlResultPrivateType = props.data
  ...
  return (
    <div className=" border rounded-lg flex flex-wrap justify-between items-center content-center p-5 m-2 gap-2">
      ...
      <div className=' flex flex-col gap-2'>
        ...
        <div className=' flex justify-center items-center h-16 w-16 border-black border-2 rounded-full'>
          {url.Statistics.length === 0 ? 0 : url?.Statistics[0]?.visitors}
        </div>
      </div>
